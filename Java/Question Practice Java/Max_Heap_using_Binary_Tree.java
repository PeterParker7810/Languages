...
class Heap {
    ...
    private void heapify(Node node) {
        ...
        Node largest = node;
        if (node.left != null && node.left.data > largest.data) largest = node.left;
        if (node.right != null && node.right.data > largest.data) largest = node.right;
...
public class Max_Heap_using_Binary_Tree {
    public static void main(String[] args) {
        Scanner input = new Scanner(System.in);
        Heap heap = new Heap();
        System.out.println("Max Heap Functions:\n1. Insert\n2. Delete Max\n3. Find Max\n4. Find Min\n5. Display");
